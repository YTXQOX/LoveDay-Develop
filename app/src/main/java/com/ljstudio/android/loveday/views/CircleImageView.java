...
//            canvas.drawCircle(mDrawableRect.centerX() , mDrawableRect.centerY() + mBorderWidth,
//                    mDrawableRadius + mBorderWidth + 2, mBorderPaint);
        }
...
//        mBitmapPaint.setShadowLayer(10, 6, 6, 0xFFFF00FF);
